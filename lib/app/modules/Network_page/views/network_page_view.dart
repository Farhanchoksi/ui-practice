...
import 'package:ui_project/app/modules/Network_search_page/views/network_search_page_view.dart';
...
//import 'package:ui_project/app/modules/Network_search_page/controllers/network_search_page_controller.dart';
import '../controllers/network_page_controller.dart';

class NetworkPageView extends GetView<NetworkPageController> {
 NetworkPageView({super.key});

  final controller = Get.put(NetworkPageController());
                  ...
                  if (controller.isLoading.value) {
                    ...
                    return Center(child: Column(
                      ...
                      children: [
                        ...
                        Text('No results found', style: TextStyle(fontSize: 16, color: HexColor('333F64')),)
                      ],
                    ) );
                  } else {
